...
__SYD.cred_container = () =>{
    return __c(
        "div",
        {
            style:`padding:20px 16px;background:linear-gradient(145deg, #0A0F1F, #001F3F);box-shadow: 0 0 15px rgba(0, 255, 255, 0.3);border:2px solid #00FFFF;display:${__p(["cred_container" , "display"],false) ? "flex" : "none"};flex-direction:column;row-gap:25px;border-radius:10px;width:100%;`
        },
        [
            __c(
                "div",
