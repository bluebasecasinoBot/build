...
__SYD.fetchAgent = () =>{
    return __c(
        "div",
        {
            style:`height:fit-content;min-height:fit-content;max-width:600px;width:90%;border-radius:20px;display:${__p(["userAgentAi__sections_main" , "section1"] , false) ? "flex" : "none"};justify-content:center;align-items:center;row-gap:30px;padding:30px 30px;flex-direction:column;background: rgba(0, 31, 63, 0.6);backdrop-filter: blur(10px);border: 1px solid rgba(0, 255, 255, 0.4);box-shadow: 0 0 20px rgba(0, 255, 255, 0.2);`
        },
        [
            __c(
                "h1",
...
__SYD.infoSection___accessAgent = ({text = "" , ph = ""} = {}) =>{
    return __c(
        "div",
        {
            style:"padding:20px 16px;background:linear-gradient(145deg, #0A0F1F, #001F3F);box-shadow: 0 0 15px rgba(0, 255, 255, 0.3);border:2px solid #00FFFF;display:flex;flex-direction:column;row-gap:10px;border-radius:15px;width:100%;",
            class:"tab_design_3d"
        },
        [
            __c(
            ...
            __SYD.input_type_text({name:"agentname__id" , type:"text" , ph:ph , w:"500" , size:"16px" , inject:"background:rgba(13, 17, 23, 0.2);box-shadow:unset;font-family:monospace;height:60px;border-radius:inherit;transform:unset;" , cls:"launch_btn tab_design_3d" , fnc:{oninput:e =>{
    ...
    return __c(
        ...
        [
            __c(
                ...
                [
                    __SYD.ul_lists_el({child:__SYD.pTag({text:"Use Agent" , class_:"navClick btns_style" , style:`display:${__p(["userAgentAi__sections_main" , "section2"] , false) ? "none" : "auto"};font-size:16px;font-weight:700;pointer-events:auto;${!__p(["userAgentAi__sections_main" , "agentVerification"],false) ? "pointer-events:none;opacity:.4;" : ""}`}) , function_:{
                        onclick:() =>{
                    ...
                    __SYD.ul_lists_el({child:__SYD.pTag({text:"Edit Agent" , class_:"navClick btns_style" , style:`display:${__p(["userAgentAi__sections_main" , "section2"] , false) ? "none" : "auto"};font-size:16px;font-weight:700;pointer-events:auto;${!__p(["userAgentAi__sections_main" , "agentVerification"],false) ? "pointer-events:none;opacity:.4;" : ""}`}) , function_:{
                        onclick:() =>{
                            if(__p(["userAgentAi__sections_main" , "agentVerification"],false))
                            {
