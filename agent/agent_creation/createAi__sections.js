...
__SYD.infoSection = ({text = "" , ph = ""} = {}) =>{
    return __c(
        ...
        [
            ...
            __SYD.input_type_text({name:"first name" , type:"text" , ph:ph , w:"500" , size:"16px" , inject:"background:rgba(13, 17, 23, 0.2);box-shadow:unset;font-family:jose;height:60px;border-radius:inherit;transform:none;" , cls:"launch_btn tab_design_3d" , fnc:{oninput:e =>{
    ...
    return __c(
        ...
        [
            ...
            __c(
                "select",
                {
                    style:"background:#0D1117;font-family:jose;height:60px;border-radius:inherit;font-size:16px;color:#fff;cursor:pointer;transform:none;",
                    class:"tab_design_3d"
                },
                [
                    __c(
...
__SYD.infoSection__radioBox = ({text = "" , options = ["Yes" , "No"] , ph = ""} = {}) =>{
    return __c(
        "div",
        {
            style:"padding:20px 16px;background:#0D1117;display:flex;flex-direction:column;row-gap:10px;border-radius:15px;"
        },
        [
            __c(
                "h2",
