...
__SYD.agent_use_chat_main = () =>{
    return __c(
        "div",
        {
            style:`height:100%;width:100%;max-width:1000px;background: rgba(0, 31, 63, 0.6);backdrop-filter: blur(10px);border: 1px solid rgba(0, 255, 255, 0.4);box-shadow: 0 0 20px rgba(0, 255, 255, 0.2);display:${__p(["userAgentAi__sections_main" , "section2"] , false) ? "flex" : "none"};justify-content:center;align-items:center;min-height:100vh;`
        },
        [
            __c(
                "h2",
...
__SYD.chatArea__agent = () =>{
    ...
    return __c(
        "div",
        {
            style:"height:100%;width:100%;background:linear-gradient(300deg, #0A0F1F, #001F3F);border-radius:15px;padding:10px;padding-top:40px;display:flex;flex-direction:column;overflow:scroll;"
        },
        [
            ...get_render_chat(),
            __c(
...
__SYD.messageTab = () =>{
    return __c(
        ...
        [
            __SYD.userTextCount(),
            __SYD.textArea_type_text({name:"agentname__id" , type:"text" , ph:"Enter your message" , w:"500" , size:"16px" , inject:"background:rgba(13, 17, 23, 0.2);box-shadow:unset;font-family:monospace;height:80px;border-radius:inherit;width:100%;resize:none;padding:16px;" , cls:"launch_btn tab_design_3d" , fnc:{oninput:e =>{
