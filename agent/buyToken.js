    ...
    return __c(
        ...
        [
            __c(
                'div',
                {
                    style:`font-size:${__p(['subContainer','scaled'],false) ? '60px' : '35px'};text-transform:capitalize;font-weight:400;padding:5px;width:fit-content;color:#fff;text-align:center;text-shadow:3px 3px 0px #01283c;font-family:shine;`,
                    class:"text1 headerMainGrad text_border_decoration"
                },
                [
                    'Buy Build',__c("span",{style:"min-height:40px;min-width:40px;background-size:150%;background-image:url(./assets/buildGif.gif);display:inline-block;"},[],{genericStyle:['bg_cover']}),' on uniswap'
                ]
            ),
            __c(
                "div",
                ...
                [
                    __c(
                        'div',
                        {
                            style:`font-size:${__p(['subContainer','scaled'],false) ? '20px' : '20px'};text-transform:none;font-weight:400;padding:5px;width:90%;color:#0099FF;text-align:center;text-shadow:1px 1px 2px #000;`,
                            class:"text2"
                        },
                        [
