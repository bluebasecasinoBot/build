    ...
    return __c(
        ...
        [
            ...
            __c(
                "div",
                {
                    style:"display:flex;column-gap:15px;row-gap:15px;column-gap:25px;width:fit-content;justify-content:center;align-items:center;flex-wrap:wrap;background:linear-gradient(145deg, #0A0F1F, #001F3F);border-radius: 12px;box-shadow: 0 0 15px rgba(0, 255, 255, 0.3);padding:20px;border:2px solid #00FFFF;"
                },
                [
