    ...
    return __c(
        ...
        [
            __c(
                'div',
                {
                    style:`font-size:${__p(['subContainer','scaled'],false) ? '60px' : '35px'};text-transform:uppercase;font-weight:400;padding:5px;text-align:center;text-shadow:3px 3px 0px #01283c;font-family:shine;`,
    ...
    return __c(
        ...
        [
            ...
            __c(
                'div',
                {
                    style:'font-size:20px;font-weight:unset;padding:10px;width:100%;font-family:shine;margin-bottom:15px;z-index:15;color:#0099FF;',
